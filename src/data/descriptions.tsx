...
export const descriptions: any = {
    ...
    "carbonyl_noLG__amine": `<p>Lecture 14, page 6. Reductive amination.</p><p class="note">Start with an aldehyde or ketone & react with amines.</p><img src="https://user-images.githubusercontent.com/20177171/119913693-67b2ff80-bf13-11eb-86db-0f5fc1435988.png" alt="rxn"/>`,
