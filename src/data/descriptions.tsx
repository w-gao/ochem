...
export const descriptions: any = {
    ...
    "RMgBr__alcohol_nonaryl": `<p class="note">Formaldehyde, aldehyde, and ketone reacts with grignard to give primary, secondary, and tertiary alcohols, respectively.</p><p>Phenol not included.</p>`,
    ...
    "RMgBr__carboxylic_acid": `Lecture 7, page 5. Can be primary/secondary/tertiary/aromatic. <p class="note">Product has one extra C-atom (from CO<sub>2</sub>).</p>`,
