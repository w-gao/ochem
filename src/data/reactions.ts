...
export const add_reactions = (edges: Reaction[]) => {
    edges.push(
        ...
        {id: "propiophenone__propylbenzene", source: "propiophenone", target: "propylbenzene", label: REAGENTS["H2/Pd"], sep: "30% 50%", tep: "-50% -10%"},
        ...
        {id: "carboxylic_acid__acid_chloride", source: "carboxylic_acid", target: "acid_chloride", label: REAGENTS["SOCl2"], cpd: "-2em", sep: "15% 50%", tep: "15% -50%"},
